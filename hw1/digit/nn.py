...
class ErrorRatePlotterCallback(pl.Callback):
    def __init__(self, smoothing_factor=0.1, output_dir="./hw1/output/digit"):
        super().__init__()
...
def evaluate_hyperparameters(
    hyperparameter_values, hyperparameter_name, output_dir="./hw1/output/digit"
):
    results = []
...
def plot_hyperparameter_tuning_results(
    results, hyperparameter_name, output_dir="./hw1/output/digit"
):
